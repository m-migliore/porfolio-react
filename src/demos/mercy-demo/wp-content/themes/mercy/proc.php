...
$msg.="<div style='width: 600px; border-radius: 5px;'><span style='font-size: 16px; font-weight: 400; color: #000; display: block; text-align: left; padding: 20px; background-color: #f4f4f4; margin-left: 20px;'><big>Message Received</big><br><br>Thank you for contacting Mercy. We have received your message and are sending this receipt in confirmation. We will respond by phone or email shortly. For an urgent matter, please call us at 612-252-7000. Thank you for your patience, we'll be in touch soon. <br><br>Sincerely,<br>Mercy </span></div>";
$msg.="<br>";
